...
export async function getSortedPostsData(page = 1) {
  ...
  export async function getCategories() {
    // This is just a hardcoded example. Replace with your actual method of getting categories.
    return [
      { name: "Books", color: "blue" },
      { name: "Film", color: "red" },
      { name: "Scorpion Rearing", color: "green" },
