...
export default async function Post({ params }) {
  ...
  return (
    <div className="flex flex-col mx-auto w-full px-4 md:px-8">
      <article className="prose prose-p:text-[1.4rem]/[1.75rem] prose-h3:text-3xl prose-pre:p-0 prose-code:text-md prose-code:rounded-custom prose-code:text-textPrimary prose-xl prose-headings:font-sans prose-h3:font-bold w-full prose-p:font-serif prose-ul:font-serif prose-h1:text-4xl prose-p:text-textPrimary prose-ul:text-textPrimary prose-ul:list-disc prose-li:text-textPrimary mx-auto mt-4 mb-20">
